...
@ScriptManifest(
        name = "TalkTo",
        description = "Handles the TalkTo random.",
        version = 1.0,
        authors = "Pat-ji"
)
public class TalkToRandom extends RandomScript {
    private static final String[] NAMES = { "Genie"/*, "Drunken Dwarf", "Security Guard", "Cap'n Hand",
            "Rick Turpentine", "Mysterious Old Man" */};
    ...
    public RandomEvent.Event getEvent() {
        return RandomEvent.Event.TALK_TO;
    }
